...
export class LineBasedTypeScriptService {
  ...
  private realFiles = new Map<string, string>(); // Map virtual URI to real file path
   ...
   */
  getQuickInfoAtPosition(uri: string, line: number, character: number): string | undefined {
